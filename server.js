...
app.all("/" + process.env.BOT_ENDPOINT, function(request, response) {
	...
	var message_options = [
		...
		"Tenemos que reconstruir un país que dejaron endeudado de un modo impresionante, aniquilado económicamente, han condicionado el futuro de muchas generaciones y sumido en la pobreza a más del 40% de los argentinos. Estos son los Andes que tenemos que cruzar hoy.\n-Alberto Fernandez",
